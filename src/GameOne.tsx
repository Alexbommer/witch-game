...
const GameOne: React.FC<GameOneProps> = ({ onNext }) => {
  ...
  if (parseInt(selectedWinner) === correctWinner) {
    ...
    onNext(); // go to next game
  } else {
    // Wrong → reveal correct winner + restart
